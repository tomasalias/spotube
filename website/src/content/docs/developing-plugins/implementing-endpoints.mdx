...
| `savedTracks()`     | Fetches the user's saved tracks with pagination support.                 | [`SpotubePaginationResponseObject`][SpotubePaginationResponseObject] of [`SpotubeTrackObject`][SpotubeTrackObject]               |
...
| Method       | Description                                                                          | Returns                                          |
| ------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------ |
| `getTrack()` | Fetches track information by ID.                                                     | [SpotubeTrackObject][SpotubeTrackObject]         |
...
| `radio()`    | Fetches related tracks based on specified tracks. Try to return a List of 50 tracks. | [List\<SpotubeTrackObject\>][SpotubeTrackObject] |
...
| `tracks()`   | Fetches tracks of the specified album. Accepts an ID and optional pagination parameters. | [`SpotubePaginationResponseObject`][SpotubePaginationResponseObject] of [`SpotubeTrackObject`][SpotubeTrackObject]         |
...
| `topTracks()` | Fetches top tracks of the specified artist. Accepts optional pagination.               | [`SpotubePaginationResponseObject`][SpotubePaginationResponseObject] of [`SpotubeTrackObject`][SpotubeTrackObject]           |
...
| `tracks`         | Fetches tracks in a playlist.               | [`SpotubePaginationResponseObject`][SpotubePaginationResponseObject] of [`SpotubeTrackObject`][SpotubeTrackObject] |
...
| `tracks()`    | Searches only for tracks.           | [`SpotubePaginationResponseObject`][SpotubePaginationResponseObject] of [`SpotubeTrackObject`][SpotubeTrackObject]               |
...
[SpotubeTrackObject]: /docs/reference/models#track
